...
<head>
    ...
    <link rel="stylesheet" href="../recursos/css/bootstrap-material-design.min.css">
    <link rel="stylesheet" href="../recursos/css/bootstrap.min.css">
    <link rel="stylesheet" href="../recursos/css/bootstrap.min.css.map">
    <link rel="stylesheet" href="../recursos/css/normalize.css">
    <link rel="stylesheet" href="../recursos/css/style.css">
    <link rel="stylesheet" href="../recursos/css/sweetalert2.min.css">
...
<body>
		...
		<section class="full-box nav-lateral">
			...
			<div class="full-box nav-lateral-content">
				<figure class="full-box nav-lateral-avatar">
					...
					<img src="../recursos/img/user.png" class="img-fluid" alt="Avatar">
					<figcaption class="roboto-medium text-center">
						Steven Rojas <br><small class="roboto-condensed-light">Web Developer</small>
					</figcaption>
				</figure>
    ...
    <script src="../recursos/js/bootstrap-material-design.min.js"></script>
