...
<link rel="stylesheet" href="../recursos/dashboard/css/styles.min.css" type="text/css">
<link rel="stylesheet" href="../recursos/dashboard/css/stylos.css" type="text/css">
<link rel="shortcut icon" href="../recursos/img/mango-and-lef-png.ico" type="image/x-icon">
...
<script src="../recursos/dashboard/js/app.min.js"></script>
<script src="../recursos/dashboard/js/simplebar.js"></script>
