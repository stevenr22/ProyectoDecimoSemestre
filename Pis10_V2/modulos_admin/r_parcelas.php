...
<body>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if ($estado === 'Deshabilitado') { ?>
                                                            <button type="button" class="btn btn-success"
                                                                onclick="habilitarParcela('<?php echo $arreglo['id_parcela']; ?>', '<?php echo $arreglo['nombre']; ?>');"
                                                                id="verde">
    ...
    <script>
        ...
        //----------------------------------------------------------------
        //habilitar parcela
        function habilitarParcela(id_parcela, nombre) {
            swal.fire({
                title: 'Está seguro?',
                icon: 'warning',
                text: 'Desea habilitar la parcela:' + nombre,
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '../actualizar/activar_parcela.php',
                        type: 'POST',
                        data: {
                            id_parcela: id_parcela
                        },
                        success: function (response) {
                            Swal.fire({
                                title: 'Habilitado',
                                icon: 'success',
                                text: 'La parcela' + nombre + 'se habilitado con exito!',
                                confirmButtonText: 'ok',
                            }).then((result) => {
                                /* Read more about isConfirmed, isDenied below */
